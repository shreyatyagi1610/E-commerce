...
import {getMaincategory,updateMaincategory} from "../../../ActionCreators/MainCategoryActionCreator.jsx"
    ...
    function getInputData(e) {
     ...
     function postData(e) {
        ...
        if (error) {
            ...
            let item = MaincategoryStateData.find(x => String(x.id) !== String(id) && x.name.toLowerCase() === data.name.toLowerCase())
            if (item) {
                seterrormessage((old) => {
                    return {
                        ...old,
            ...
            <div className="container-fluid my-3">
                <div className='row'>
                    ...
                    <div className='col-md-9 mb-3'>
                        <h5 className='bg-primary text-light text-center p-2'>Update MainCategory <Link to="/Admin/MainCategory"><i className='fa fa-list text-light float-end'></i></Link></h5>
