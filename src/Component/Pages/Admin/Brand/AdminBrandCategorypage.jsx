...
import { getBrand, deleteBrand,} from "../../../../ActionCreators/BrandCategoryActionCreator"

export default function AdminBrandCategorypage() {
    ...
    <div className="container-fluid my-3">
      <div className='row'>
        ...
        <div className='col-md-9 mb-3'>
          <h5 className='bg-primary text-light  text-center p-2'>BrandCategory<Link to="/Admin/BrandCategory/Create"><i className='fa fa-plus text-light float-end'></i></Link></h5>
            ...
            <tbody>
              {
                BrandStateData.map(item => {
                  return <tr key={item.id}>
                    ...
                    <td><Link to={`/admin/BrandCategory/update/${item.id}`} className='btn btn-primary'><i className='fa fa-edit'></i></Link></td>
